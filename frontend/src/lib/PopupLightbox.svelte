...
>
  ...
  <div class="flex-1 flex items-center justify-center relative">
    ...
    {:else if images[idx]}
      <img alt="" class="max-w-full max-h-[92vh] object-contain z-0 rounded-lg" src={imgSrc(images[idx], 1600)} />
    {/if}
  ...
  <div class="w-[320px] shrink-0 border-l border-white/10 bg-[#0a0a0a] flex flex-col overflow-y-auto p-4 gap-4">
    {#if images[idx]}
